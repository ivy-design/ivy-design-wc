...
<template>
  <div :class="classList" :style="{'--ivy-divider-line-type': props.type}">
    <span v-if="!props.vertical && props.value" class="ivy-divider-inner__text">{{ props.value }}</span>
  </div>
</template>
